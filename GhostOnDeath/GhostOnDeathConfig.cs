...
namespace AlexioXela
{
    class GhostOnDeathConfig
    {
        ...
        private readonly ConfigEntry<bool> _enableGhostOnDeath;
        ...
        */
        ...
        public bool EnableGhostOnDeath { get => _enableGhostOnDeath.Value; }
        ...
        {
            _enableGhostOnDeath = config.Bind("Master", "EnableGhostOnDeath", true, "Enables/Disables the entire mod.");
            ...
            */
            ...
            _preventPrefabResetMethods = config.Bind("Debug", "PreventPrefabResetMethods", "SwapCharacters, RevertCharacter, CCSpawnAs", "Manually set methods to not be affected by GhostOnDeath's BodyPrefab-Resetting behavior. (Don't touch this unless you know what you're doing.)");
        }
        ...
        public void BuildRiskOfOptionsMenu()
        {
            ...
            ModSettingsManager.SetModDescriptionToken("GHOSTONDEATH_MOD_DESCRIPTION");

            // For all of our settings:
            ModSettingsManager.AddOption(new RiskOfOptions.Options.CheckBoxOption(_enableGhostOnDeath));
